 ...
 * @author Carola Bauer
 */
public class EulerMaxBasedRankingReasoner_Without_SelfAttacking extends AbstractRankingReasoner<NumericalPartialOrder<Argument, DungTheory>> {
     ...
     */
    private double calculateEulerMaxBasedFunction(double[] vOld, Matrix directAttackMatrix, int i) {
        double max = 0.;
